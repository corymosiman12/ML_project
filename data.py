...
utils.spectral_density([vel_coarse['u'], vel_coarse['v'], vel_coarse['w']], dx_coarse, Npoints_coarse, plot_folder+'coarse_grid')
utils.spectral_density([vel_filtered['u'], vel_filtered['v'], vel_filtered['w']], dx_coarse, Npoints_coarse, plot_folder+'filtered')
