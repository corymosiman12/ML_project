...
plotting.imagesc([vel_filtered['u'], vel_filtered['v'], vel_filtered['w']], [r'$\widetilde{u}$', r'$\widetilde{v}$', r'$\widetilde{w}$'], plot_folder + 'gaussian filter')

logging.info('Calculating spectra')
utils.spectral_density([velocity['w']], dx_fine, Npoints_fine, plot_folder+'fine_grid')
utils.spectral_density([vel_coarse['w']], dx_coarse, Npoints_coarse, plot_folder+'coarse_grid')
utils.spectral_density([vel_filtered['w']], dx_coarse, Npoints_coarse, plot_folder+'filtered')
